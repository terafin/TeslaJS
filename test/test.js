...
describe('TeslaJS', function () {
	...
	describe('#vehicle()', function () {
	    it('should succeed enumerating the first vehicle', function (done) {
	...
	describe('#vehicleAsync()', function () {
	    it('should succeed enumerating the first vehicle', function () {
	...
	describe('#vehiclesAsync()', function () {
	    it('should succeed enumerating vehicles', function () {
	        return tjs.vehiclesAsync(options).then(function (vehicles) {
	            assert(vehicles[0].vehicle_id);
	        });
	    });
	});
